(function() {
    ...
    // Добавление параметров в настройки (сохранена оригинальная структура)
    ...
    function showExitMenu() {
        ...
        Lampa.Modal.show({
            ...
            'onSelect': function(item) {
                if (item.title == _0xe5f56f) exitApp();
                if (item.title == _0x527c65) location.reload();
                if (item.title == _0x5ec0f8) switchServer();
                if (item.title == _0x484780) clearCache();
                if (item.title == _0x266c73) window.location.href = 'https://youtube.com/tv';
                if (item.title == _0x2c52be) window.location.href = 'https://rutube.ru/tv-release/rutube.server-22.0.0/webos/';
                if (item.title == _0x5ac2b0) window.location.href = 'https://ott.drm-play.com';
                if (item.title == _0x4b474b) window.location.href = 'https://webos.tv.twitch.tv';
                if (item.title == _0x3ae72d) window.location.href = 'http://browser.appfxml.com';
                if (item.title == _0x121b2c) showSpeedTest();
            }
        });
    }
