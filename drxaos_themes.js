...
function showUnknownQualityBadge(element) {
    ...
    function drxaosBindActivityWheel(activity) {
        ...
        activity.addEventListener('wheel', handler, { passive: false });
    ...
    try {
        ...
        if (preset.href && !IS_LOW_POWER_DEVICE) {
            ...
            if (preset.href && IS_LOW_POWER_DEVICE) {
                ...
                preset = Object.assign({}, preset, { href: null });
            }
        }
...
if (!drxaosIsMakerEnv) {
    ...
    if (window.Lampa && window.Lampa.Listener) {
        ...
        window.Lampa.Listener.follow('hover', function(e) {
            ...
            var target = null;
            if (e) {
                if (e.card) { target = e.card; }
                else if (e.object && e.object.card) { target = e.object.card; }
