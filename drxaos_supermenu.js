(function () {
  ...
  function init() {
    try {
      ...
      console.error("[SuperMenu] Critical error during initialization:", e);
    }
  }
  ...
  function bootstrapSuperMenu() {
    try {
      ...
      Lampa.Plugin.add({
        plugin: "drxaos_supermenu",
        name: "DrXAOS SuperMenu",
        icon: "https://i.ibb.co/6Ft7q9D/logo.png",
        size: 0,
        source: "https://i.ibb.co/6Ft7q9D/logo.png",
        start: function () {
          init();
        }
      });
      ...
      console.error("[SuperMenu] Bootstrap error:", e);
    }
  }
